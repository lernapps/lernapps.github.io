...
export const BELEGE = {
  ...
  "threat-modeling": ["datei:src/docs/arc42/chapters/08_concepts.adoc"],
  "code-review": ["github:branches/main/protection"],
  ...
  "ui-prose-lint": ["funktion:lib/pruefungen.js#pruefeTutorText"],
  "link-checker": ["funktion:lib/llms-vertrag.js#pruefeLink", "funktion:lib/pruefungen.js#pruefeSerloLinks",
  ...
  "prose-lint": ["funktion:lib/pruefungen.js#pruefeZeilen", "datei:eleventy.config.js"],
