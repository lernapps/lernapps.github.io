...
const ROH = [
  ...
  [S, "sca", "SCA", "G", 1, "vorhanden", "Dependabot-Alerts und -Security-Updates; `npm audit --audit-level=high` im Pflicht-Check, #20"],
  ...
  [U, "ui-prose-lint", "UI prose lint", "G", 2, "in Arbeit", "Vorhanden ist nur eine Regex: Tutor-Texte nennen keinen Wettbewerb (`pruefeTutorText`, #29). Es fehlt ein Prose-Linter für UI-Texte (Anrede „du“, Terminologie, Satzlänge)"],
  ...
  [Doc, "prose-lint", "Prose lint", "A", 2, "in Arbeit", "Vorhanden ist nur die Längengrenze: `tutor.md` unter 120 Zeilen (`MAX_TUTOR_ZEILEN`, #29). Es fehlt ein Prose-Linter für Doku und Kompetenztexte (Stil, Satzlänge, Terminologie)"],
