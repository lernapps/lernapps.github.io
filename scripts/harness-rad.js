...
const ROH = [
  ...
  [S, "llm-security-review", "LLM security review", "A", 2, "vorhanden", "OWASP-Teil des KI-Reviews (`werkzeuge/review/ki-review.md`), Check `ki-review`, #24, ADR-026"],
  ...
  [A, "llm-code-review", "LLM code review", "A", 2, "vorhanden", "KI-Review in frischem Kontext vor jedem Merge (`werkzeuge/review/ki-review.md`), Check `ki-review`, #24, ADR-026"],
