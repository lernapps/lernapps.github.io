...
(xref:11_technical_risks.adoc#r-008[R-008]). Je Seite ist nur ein Video vorgesehen (TD-17).
...
*Status.* Accepted (inferred). Den Umzug in den Build hat ADR-012 nötig gemacht; die Begründung für
„Build-Fehler statt Warnung“ ist erschlossen.
