...
(xref:11_technical_risks.adoc#r-015[R-015]). Die alten Einzel-Repos laufen parallel weiter, bis sie
gelöscht sind, und veralten (xref:11_technical_risks.adoc#r-016[R-016]). Ein Fehler im Build oder Kern trifft alle Apps
