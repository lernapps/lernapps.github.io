// ADR-012 bis ADR-019: Entscheidungen des Monorepos lern-apps.
...
(xref:11_technical_risks.adoc#r-015[R-015]). Die alten Einzel-Repos laufen parallel weiter und
veralten (xref:11_technical_risks.adoc#r-016[R-016]). Ein Fehler im Build oder Kern trifft alle Apps
...
Hilfsskript der Vorlage ist noch nicht portiert (TD-20). Längere HTML-Abschnitte im Front Matter sind
unhandlich; mehrere Videos je Seite sieht das Gerüst nicht vor (TD-17). Accepted without tracked risk.
...
jetzt auch die Lehrplandaten von 16 Ländern. Die alte Karte läuft parallel weiter
(xref:11_technical_risks.adoc#r-016[R-016]); Einträge nennen `lizenz: ""`
...
(`PLAY_SYMBOL`, `src/kern/js/video.js:62-80`, mit Test). Der Hinweis nennt YouTube als Text.

*Status.* Accepted (inferred). Die Begründung steht in PR #3; eine ausdrückliche Bestätigung des
Nutzers ist nicht dokumentiert.
