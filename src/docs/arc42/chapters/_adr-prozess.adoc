...
`scripts/dtc-v4.sh` ruft es vor docToolchain auf; `doku.yml` ruft es zusätzlich vor dem AsciiDoc-Lint auf.
Die Dateien sind git-ignoriert. `test/build/dashboard.test.js` läuft in `npm test` gegen das echte
