...
*Konsequenzen.* Die Schicht „Markdown / AsciiDoc lint“ steht auf „vorhanden“; Markdown-Dateien prüft sie
nicht. Das Werkzeug ist ein reines Entwicklungswerkzeug: Es läuft nur in `doku.yml` mit Leserechten und
